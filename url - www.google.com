...
<head>
    ...
    <title>Soo-Jong Rey</title>
    <meta name='description' content="">
    <link rel='canonical' href="soojongrey.gihub.io/">
    <link rel='alternate' type='application/rss+xml' title='Soo-Jong Rey' href="soojongrey.gihub.io/feed.xml">
    ...
    * ::selection {
    ...
    .c-logo__link:hover, .c-logo__link:active, .c-logo__link:focus {
        color: #00A0FF;
        text-decoration:none
    }
    ...
    .c-pagination:hover, .c-pagination:active, .c-pagination:focus {
        color: #00A0FF;
        text-decoration:none
    }
    ...
    .twitter-tweet, .fluid-width-video-wrapper {
    ...
    .c-social-nav__icon:hover, .c-social-nav__icon:active, .c-social-nav__icon:focus {
        fill:#00A0FF
    }
                        ...
                        <div class='o-grid'>
                            <div class='o-grid__col o-grid__col--3-4-s'>
                                <div class='c-logo u-text-left'>
                                    <a class='c-logo__link' href='/'>Soo-Jong Rey</a>
                                </div>
                            </div>
                            ...
                            <div class='o-grid__col o-grid__col--1-4-s'>
                                <div class='c-off-canvas-content'>
                                    ...
                                    <ul class='c-nav o-plain-list '>
                                        ...
                                        <li class='c-nav__item' role='presentation'>
                                            <a class='c-nav__link' href='/publications.html'>Publications</a>
                                        </li>

                                        <li class='c-nav__item' role='presentation'>
                                            <a class='c-nav__link' href='/teaching.html'>Teaching</a>
                                        </li>
                                        ...
                                        <article class='c-post'>
                                            <h1 class='c-post__title u-text-center'></h1>
                                             ...
                                             <div class='c-content'>
                                                ...
                                                <img src='https://github.com/soojongrey/soojongrey.github.io/blob/main/soojongrey.jpeg?raw=true' class='c-post__image' alt=' ' width="180" height="240">

                                                <p>
                                                    Prolific Gedanken Experimentalist, Theorist of Everything and Distinguished Professor of Fundamental Research @ Kwangwoon University. 

Ph.D. in Theoretical Physics @ CALTECH, M.Sc. in Physics @ Brown University, and B.Sc. in Science Education @ College of Education, Seoul National University. 
                                                </p>

                                                <p>
Research hovers around quantum field theory, cosmological-gravitational physics, string theory, high-energy physics, quantum many-body system (physics, chemistry, biology), quantum computation and statistical physics of deep learning. Super keen on emergence and convergence among these topics. 
                                                </p>

                                                <p>
                                                    Email: sjrey@kw.ac.kr 
                                                    <br/>
                                                  
                                                    
                                                    <a href="https://scholar.google.com/citations?user=EzPww4wAAAAJ&hl=en">Google Scholar</a>
    ...
    <script src="/js/evil-icons.min.js">
    </script>
